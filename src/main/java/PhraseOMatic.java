public class PhraseOMatic {
    ...
    public static void main (String[] args) {
        ...
        //Три набора слов.
        String[] wordListOne = {"круглосуточный", "трех-звенный", "30000-фунтовый", "взаимный", "обоюдный выигрыщ", "фронтэнд", "на основе веб-технологий", "проникающий", "умный", "шесть сигм", "метод критического пути", "динамичный"};
